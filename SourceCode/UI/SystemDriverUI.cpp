  ...
  {
    {
      ...
      auto User  = Domain::User::UserHandler::createSession( {"Tom", "CPSC 462 Rocks!", {"Borrower"}} );
      auto commands = User->getCommands();
      auto results  = User->executeCommand( "Checkout Book", {"Applied UML and Patterns", "Larman", "0-13-148906-2"} );
      //session->singOff();
